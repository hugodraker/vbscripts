...
Dim exportStarted : exportStarted = False   ' <-- Only create file after success
...
' ==============================================================================
' Only create the .sql file AFTER first successful DB access
' ==============================================================================
Dim sqlFileCreated : sqlFileCreated = False
...
Do While Not rsDBs.EOF
    ...
    Else
        ...
        ' Create SQL file only now (first successful DB)
        If Not sqlFileCreated Then
...
' Finalization
' ==============================================================================
If sqlFileCreated Then
    outFile.Close
    WScript.Echo "========================================="
    WScript.Echo "Export complete! File saved to: " & OUTPUT_FILE
Else
    WScript.Echo "========================================="
    WScript.Echo "No databases were successfully processed. No SQL file created."
End If
